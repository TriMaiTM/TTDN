...
export const routes: Route[] = [
  ...
  { path: 'admin', component: AdminComponent, title: 'Admin Panel', data: { animation: 'AdminPage' } },
  { path: 'admin/simple-test', component: SimpleTestComponent, title: 'Simple Test', data: { animation: 'AdminPage' } },
  { path: 'admin/data-init', component: DataInitializationComponent, title: 'Khởi tạo dữ liệu', data: { animation: 'AdminPage' } },
  { path: 'admin/firebase-test', component: FirebaseTestComponent, title: 'Firebase Test', data: { animation: 'AdminPage' } },
  { path: 'admin/products', component: ProductManagementComponent, title: 'Quản lý sản phẩm', data: { animation: 'AdminPage' } },
  { path: 'admin/categories', component: CategoryManagementComponent, title: 'Quản lý danh mục', data: { animation: 'AdminPage' } },
  { path: 'admin/news', component: NewsAdminComponent, title: 'Quản lý tin tức', data: { animation: 'AdminPage' } },
